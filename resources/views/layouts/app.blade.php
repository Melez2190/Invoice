...
<main class="bg-gray-100 font-sans leading-normal tracking-normal">
    <div class="flex md:flex-row-reverse flex-wrap">
       ...
       <!--Sidebar-->
       <div class="w-full md:w-40 mt-8 bg-gray-900 md:bg-gray-900 px-2 text-center fixed bottom-0  md:pt-8 md:top-8 md:left-0 h-16 md:h-screen md:border-r-4 md:border-gray-600">
          <div class="md:relative mx-auto lg:float-left lg:px-0">
             <ul class="list-reset flex flex-row md:flex-col text-center md:text-left">
                <li class="mr-3 flex-1">
                   <a href="/clients/create" class="block py-1 md:py-3 pl-1 align-middle text-gray-800 no-underline hover:text-pink-500 border-b-2 border-gray-800 md:border-gray-900 hover:border-blue-900">
