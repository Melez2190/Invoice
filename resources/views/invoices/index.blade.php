...
@section('content')
    <div class="ml-12 mr-12">
        ...
        <div id="invoiceModal"  aria-hidden="true" class=" ajaxModal  hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal md:h-full md:inset-0">
          ...
          <!-- edit invoice modal -->
        <div id="editinvoiceModal"  aria-hidden="true" class=" ajaxModal  hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal md:h-full md:inset-0">
            <div class="relative px-4 w-full  mx-auto max-w-md h-full md:h-auto">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8 bg-white" id="editinvoiceForm" name="editinvoiceForm">
                        @csrf
                        <input type="hidden" name="invoice_id" id="invoice_id">
                        ...
                        <div>
                            <label for="date_of_issue" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Name</label>
                            <input type="date" name="date_of_issue" id="editdate_of_issue" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  required>
                        </div>
                        <div>
                            <label for="valuta" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">City</label>
                            <input type="date" name="valuta" id="editvaluta" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  required>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#editBtn").click(function(e){
            e.preventDefault();
            $(this).html('Edit');
            let formData = $("#editinvoiceForm").serialize();
        ...
        $(document).on('click', '.btn-edit', function(e){   
            ...
            $.ajax({
                ...
                dataType: 'json',
                success:function(data){
                    $("#client_name").val(data[1].name);
                    $("#editdate_of_issue").val(data[0].date_of_issue);
                    $("#editvaluta").val(data[0].valuta);
                }
            });
