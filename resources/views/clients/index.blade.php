...
@section('content')
    <div class="ml-48">
        <a href="javascript:void(0)" id="createNewClient" class=" bg-blue-500  text-white shadow-5xl mb-10 p-2 uppercase font-bold">Add New Client</a>
        <table id="clientsTable" class="mb-12 mt-4 w-full table table-hover dataTable table-custom table-striped m-b-0 c_list" style="width:100%">
            ...
            <thead>
                <tr class="text-left border-b-6 p-4">
                    <th class="border-separate border-b-2">No</th>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.btn-edit', function(e){
        ...
        //    $.get("{{ route('clients.store') }}"+"/"+client_id+"/edit", function(data){
